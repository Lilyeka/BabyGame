...
.directive("otcDynamic", function(){
	...
	for (var i =0; i < 9; i++)
	{
		...
		tmpl += '<td>' + '<div style="background-image: url(img/12.jpg); font-family:Verdana; font-size:10pt;border-style:groove; border-width:30px; border-color:blue; padding:4px">'+ i +'</div>'+ '</td>';
	}
	tmpl += '</td></table>';
	return {
